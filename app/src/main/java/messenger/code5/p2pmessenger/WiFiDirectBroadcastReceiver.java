...
public class WiFiDirectBroadcastReceiver extends BroadcastReceiver{
    ...
    public WiFiDirectBroadcastReceiver(final WifiP2pManager manager, final WifiP2pManager.Channel channel, ConnectionActivity connectionActivity) {
        super();
        this.manager = manager;
        this.channel = channel;
        this.activity = connectionActivity;
    }

    @Override
    public void onReceive(Context context, Intent intent) {
        ConnectionActivity.myDevice = intent.getParcelableExtra(WifiP2pManager.EXTRA_WIFI_P2P_DEVICE);
